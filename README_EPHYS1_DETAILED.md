...
The common analysis table is an Excel file (commonly all_peak_results_final.xlsx).
...
- normalized_peaks
- selected_10sweeps
- firingRate_10sweeps_all (some plotting cells expect this exact name)
...
5. OLD_plotting_spikes.py
- Legacy plotting script; retained as historical/backup code.
